        ...
        <FormPanel>
          <FormSection label="Account">
            ...
            <div className="fg-2" style={{ marginTop: 12 }}>
              ...
              <FormField label="Confirm Password" name="password_confirm" type="password" required value={form.data.password_confirm} onChange={set("password_confirm")} error={errors.password_confirm} />
            </div>
            <label className="ff-check" style={{ marginTop: 12 }}>
              ...
              <span>Staff <span className="check-sub">Limited access to admin menus</span></span>
            </label>
          </FormSection>
          <FormActions cancelHref="/users/" submitLabel="Create User" processing={form.processing} />
        </FormPanel>
      </form>
    </div>
  );
