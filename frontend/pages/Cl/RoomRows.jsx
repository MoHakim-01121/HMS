...
export default function RoomRows({ rooms, onChange, nights }) {
  ...
  return (
    <div>
      {rooms.length > 0 && (
        <>
          <div className="cl-rooms cl-rooms-table">
              ...
              return (
                <div key={i} className="cl-room-flat">
                  <div className="cl-room-flat-head">
                    ...
                    <button type="button" className="cl-room-card-trash" title="Delete" onClick={() => remove(i)}>
                      <Icon name="trash" size={13} />
                    </button>
                  </div>
                  <input
                    className="cl-room-card-meals" type="text" value={r.meals}
                    onChange={(e) => update(i, "meals", e.target.value)} placeholder="Meal plan (BB, HB…)"
                  />
      ...
      <div className="cl-room-add-desktop">
