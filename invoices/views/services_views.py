...
def services_list(request):
    ...
    return _paginated_list(request, qs, "invoices/services/services_history.html", "invoices")
...
def services_new(request):
    ...
    return render(request, "invoices/services/services_form.html", {
...
def services_detail(request, pk):
    ...
    return render(request, "invoices/services/services_detail.html", {
        "invoice": invoice,
...
def services_edit(request, pk):
    ...
    return render(request, "invoices/services/services_form.html", {"invoice": invoice, "edit": True})
...
def services_list_pdf(request):
    ...
    return _render_list_pdf(
        request, qs,
        template="invoices/services/services_list_pdf.html",
