...
def cl_list(request):
    ...
    return _paginated_list(request, qs, "invoices/cl/cl_history.html", "letters")
...
def cl_detail(request, pk):
    ...
    return render(request, "invoices/cl/cl_detail.html", {
        "cl": cl,
...
def cl_list_pdf(request):
    ...
    return _render_list_pdf(
        request, qs,
        template="invoices/cl/cl_list_pdf.html",
...
def invoice_from_cls(request):
    """Create an Invoice from one or more selected CLs."""
